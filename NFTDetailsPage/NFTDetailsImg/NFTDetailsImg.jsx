      ...
      <div className={Style.NFTDetailsImg_box}>
        ...
        {description && (
          <div className={Style.NFTDetailsImg_box_description_box}>
            <p>
              Pham Phuong Anh (“PPA”) is a collection of 666 kitties
              gangsters, with symbol of tattoos, living in the Proud Kitty Gang
              (“PKG”) metaverse. Each PPA is an 1/1 ID as gangster member & all
              the joint rights.
            </p>
          </div>
        )}
        ...
        {details && (
          <div className={Style.NFTDetailsImg_box_details_box}>
            ...
            <p>
              ...
              <br></br>
              0x42edefc212E298cf41cbED8ca8e6191A00Adf5e1
            </p>
            <p>
